    ...
    func updateSubtitleBasedonType(_ subtitleType: SubtitleCellValue , contact: EPContact) {
        ...
        case SubtitleCellValue.phoneNumber:
            ...
            if phoneNumberCount == 1  {
              //Sourabh  self.contactDetailTextLabel.text = "\(contact.phoneNumbers[0].phoneNumber)"
                self.contactDetailTextLabel.text = "\(contact.phoneNumbers[0])"
            }
             ...
             //   self.contactDetailTextLabel.text = "\(contact.phoneNumbers[0].phoneNumber) and \(contact.phoneNumbers.count-1) more"
                  ...
                  self.contactDetailTextLabel.text = "\(contact.phoneNumbers[0]) and \(contact.phoneNumbers.count-1) more"
            }
            else {
