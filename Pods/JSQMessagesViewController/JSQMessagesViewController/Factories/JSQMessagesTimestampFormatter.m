...
- (NSAttributedString *)attributedTimestampForDateMohan:(NSDate *)date Alignment:(int)type{
    if (!date) {
        return nil;
    }
    ...
    NSDictionary *dateTextAttributes1 =  dateTextAttributes1 = @{ NSFontAttributeName : [UIFont boldSystemFontOfSize:10.0f], NSForegroundColorAttributeName : [UIColor lightGrayColor],  NSParagraphStyleAttributeName : paragraphStyle };
  
    NSMutableAttributedString *timestamp = [[NSMutableAttributedString alloc] initWithString:relativeDate
                                                                                  attributes:dateTextAttributes1];
